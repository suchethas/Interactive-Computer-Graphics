...
/*---  Set up and pass on Model-View matrix to the shader ---*/
    ...
    mat4 mv1=mv*Translate(current_point.x,current_point.y,current_point.z)*accmat;
    //mat4 mv1=mv*Translate(current_point.x,current_point.y,current_point.z)*Rotate(angle,rot[current].x,rot[current].y,rot[current].z);
    //mat4 mv1=mv*Rotate(angle,rot[current].x,rot[current].y,rot[current].z);
...
{       
	...
	input_file.open("/Users/suchethas/sphere.8");
	input_file >> col;
